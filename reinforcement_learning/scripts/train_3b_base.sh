...
export MODEL_PATH="$SEARCHSKILL_ROOT"/supervised_finetuning/models/stage2_3b_base_merged
export RUN_NAME=rl_3b_base_from_stage2_4gpu
export OUT_DIR="$SEARCHSKILL_ROOT"/reinforcement_learning/runs/rl_3b_base_from_stage2_4gpu
export DATA_DIR="$SEARCHSKILL_ROOT"/reinforcement_learning/data/policy_3b_base
