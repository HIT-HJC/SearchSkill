...
export REF_LOG_PROB_MICRO_BATCH_SIZE="${REF_LOG_PROB_MICRO_BATCH_SIZE:-32}"
export TOTAL_STEPS="${TOTAL_STEPS:-150}"
export SAVE_FREQ="${SAVE_FREQ:-15}"
export TEST_FREQ="${TEST_FREQ:-15}"
export VAL_BEFORE_TRAIN="${VAL_BEFORE_TRAIN:-false}"
export MODEL_PATH="${MODEL_PATH:-$SEARCHSKILL_ROOT/supervised_finetuning/models/stage2_3b_instruct_merged}"
export RUN_NAME="${RUN_NAME:-rl_3b_instruct_from_stage2_4gpu}"
export OUT_DIR="${OUT_DIR:-$SEARCHSKILL_ROOT/reinforcement_learning/runs/rl_3b_instruct_from_stage2_4gpu}"
export DATA_DIR="${DATA_DIR:-$SEARCHSKILL_ROOT/reinforcement_learning/data/policy_3b_instruct}"
