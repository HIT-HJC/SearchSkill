...
export TOTAL_STEPS="${TOTAL_STEPS:-151}"
export SAVE_FREQ="${SAVE_FREQ:-15}"
export TEST_FREQ="${TEST_FREQ:-15}"
export VAL_BEFORE_TRAIN="${VAL_BEFORE_TRAIN:-false}"
export MODEL_PATH="${MODEL_PATH:-$SEARCHSKILL_ROOT/supervised_finetuning/models/stage2_7b_base_merged}"
export RUN_NAME="${RUN_NAME:-rl_7b_base_from_stage2_4gpu}"
export OUT_DIR="${OUT_DIR:-$SEARCHSKILL_ROOT/reinforcement_learning/runs/rl_7b_base_from_stage2_4gpu}"
export DATA_DIR="${DATA_DIR:-$SEARCHSKILL_ROOT/reinforcement_learning/data/policy_7b_base}"
