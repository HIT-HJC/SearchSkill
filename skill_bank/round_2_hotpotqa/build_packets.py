...
DEFAULT_CONFIG = Path(
    "/online1/ycsc_chenkh/hitici_11/HJCproject/SearchSkill Code/skill_bank/round_2_hotpotqa/config.json"
)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build grouped HotpotQA packets for B2 SkillBank evolution."
    )
