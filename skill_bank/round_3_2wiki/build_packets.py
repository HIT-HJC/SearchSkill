...
DEFAULT_CONFIG = Path(
    "/online1/ycsc_chenkh/hitici_11/HJCproject/SearchSkill Code/skill_bank/round_3_2wiki/config.json"
)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build grouped 2Wiki packets for B3 SkillBank evolution."
    )
