...
MODEL_DIR="$SEARCHSKILL_ROOT"/supervised_finetuning/models/stage2_3b_instruct
INIT_ADAPTER="$SEARCHSKILL_ROOT"/supervised_finetuning/models/stage1_3b_instruct
...
export MASTER_PORT="${MASTER_PORT:-29766}"
